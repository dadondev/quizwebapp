...
const QuizCard = ({
  ...
  return (
    <div className="max-w-[250px] rounded-lg bg-white px-5 py-3 grid">
      <span className="text-textGray">
        Nomi: <b className="text-text capitalize">{name}</b>
      </span>
      <span className="text-textGray">
        Savollar soni: <b className="text-text">{quizs.length} ta</b>
      </span>
      <p className="flex justify-center flex-row-reverse">
        <IconBtn url={"/tests/" + id}>
          <svg
